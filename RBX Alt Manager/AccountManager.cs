...
namespace RBX_Alt_Manager
{
    public partial class AccountManager : Form
    {
        ...
        private void AccountManager_Load(object sender, EventArgs e)
        {
            ...
            // Auto-update check disabled: application will no longer query GitHub releases or spawn the Auto Update.exe.
        ...
        private void DonateButton_Click(object sender, EventArgs e) =>
            // Donate link removed
            MessageBox.Show("Donate page has been removed from this build.", "Donate", MessageBoxButtons.OK, MessageBoxIcon.Information);
