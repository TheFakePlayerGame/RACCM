...
namespace RBX_Alt_Manager.Forms
{
    public partial class SettingsForm : Form
    {
        ...
        {
            // Auto-update feature disabled for this build. Prevent spawning Auto Update.exe.
            MessageBox.Show("Auto-update has been disabled in this build.", "Auto Update", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
